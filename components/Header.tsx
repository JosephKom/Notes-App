        ...
        <a className="block text-red-600" href="/">
          ...
          >
            ...
            <g id="SVGRepo_iconCarrier">
              {" "}
              <title>notes</title> <desc>Created with Sketch.</desc>{" "}
              <defs> </defs>{" "}
              <g
                id="People"
                stroke="none"
